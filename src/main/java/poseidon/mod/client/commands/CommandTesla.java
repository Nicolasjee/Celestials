...
import poseidon.mod.client.commands.util.Tesla;
import poseidon.mod.util.Reference;

public class CommandTesla extends CommandBase {

	private final List<String> aliases = Lists.newArrayList(Reference.MODID, "tesla");
	...
	public String getUsage(ICommandSender sender) {
		return "/tesla <power> | 1: CHOKE, 2: GFORCE, 3: CLOAK, 4: PUSH, 5: HEAL, 6: LIGHTNING, 7: FIREBALL, 8: TNT, 9: MINER";
	}
	...
	public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
		...
		if(sender instanceof EntityPlayer) {
			...
			Tesla.execute((EntityPlayer)sender, dimensionID);
