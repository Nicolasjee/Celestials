...
public class MapGenVillageMerchant extends MapGenStructure {
	
	/** A list of all the biomes villages can spawn in. */
	public static List<Biome> VILLAGE_SPAWN_BIOMES = Arrays.<Biome>asList(Biomes.PLAINS, Biomes.BIRCH_FOREST,
			Biomes.DESERT, Biomes.DESERT_HILLS, Biomes.FOREST, Biomes.FOREST_HILLS, Biomes.TAIGA);
	/** None */
	private int size;
	 ...
	 * @param map the map
	 */
	public MapGenVillageMerchant(Map<String, String> map) {
		this();
	...
	protected boolean canSpawnStructureAtCoords(int chunkX, int chunkZ) {
		...
		if (unadjustedX == candidateX && unadjustedZ == candidateZ) {
			// DEBUG
			System.out.println("Is biome viable for village = " + world.getBiomeProvider()
					.areBiomesViable(unadjustedX * 16 + 8, unadjustedZ * 16 + 8, 0, VILLAGE_SPAWN_BIOMES));
			return world.getBiomeProvider().areBiomesViable(unadjustedX * 16 + 8, unadjustedZ * 16 + 8, 0,
	 ...
	 * 
	 * @see
	 * net.minecraft.world.gen.structure.MapGenStructure#getNearestStructurePos(net.
	 * minecraft.world.World, net.minecraft.util.math.BlockPos, boolean)
	 */
	@Override
	public BlockPos getNearestStructurePos(World worldIn, BlockPos pos, boolean findUnexplored) {
		world = worldIn;
		return findNearestStructurePosBySpacing(worldIn, this, pos, averageSpacing, 8, 10387312, false, 100,
				findUnexplored);
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.minecraft.world.gen.structure.MapGenStructure#getStructureStart(int,
	 * int)
	 */
	@Override
	protected StructureStart getStructureStart(int chunkX, int chunkZ) {
		return new MapGenVillageMerchant.Start(world, rand, chunkX, chunkZ, size);
	}
	...
	public static class Start extends StructureStart {
		...
		public Start(World worldIn, Random rand, int x, int z, int size) {
			...
			StructureVillagePieces.Start start = new StructureVillagePieces.Start(worldIn.getBiomeProvider(), 0, rand,
					(x << 4) + 2, (z << 4) + 2, list, size);
		 ...
		 * 
		 * @see
		 * net.minecraft.world.gen.structure.StructureStart#writeToNBT(net.minecraft.nbt
		 * .NBTTagCompound)
		 */
		@Override
		 ...
		 * 
		 * @see
		 * net.minecraft.world.gen.structure.StructureStart#readFromNBT(net.minecraft.
		 * nbt.NBTTagCompound)
		 */
		@Override
