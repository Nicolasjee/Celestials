...
public class VillageHouseMerchant extends StructureVillagePieces.Village {

	private boolean isTallHouse;
	private int tablePosition;

	public VillageHouseMerchant() {
	}

	public VillageHouseMerchant(StructureVillagePieces.Start start, int type, Random rand,
