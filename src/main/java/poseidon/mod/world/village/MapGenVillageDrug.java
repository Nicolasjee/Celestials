...
public class MapGenVillageDrug extends MapGenStructure {
	 ...
	 * @param map the map
	 */
	public MapGenVillageDrug(Map<String, String> map) {
		this();
	...
	protected StructureStart getStructureStart(int chunkX, int chunkZ) {
		return new MapGenVillageDrug.Start(world, rand, chunkX, chunkZ, size);
	}
