...
public class VillageHouseDrug extends StructureVillagePieces.Village {

	/**
     * Instantiates a new village house cloud.
     */
    public VillageHouseDrug()
    {
    }
     ...
     */
    public VillageHouseDrug(StructureVillagePieces.Start parStart, int parType, Random parRand, StructureBoundingBox parStructBB, EnumFacing parFacing)
    {
	...
	public boolean addComponentParts(World parWorld, Random parRand, StructureBoundingBox parStructBB) {
		...
		IBlockState wallBlockState = getBiomeSpecificBlockState(Blocks.COBBLESTONE.getDefaultState());
		IBlockState stateStairsNorth = getBiomeSpecificBlockState(
				Blocks.STONE_BRICK_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.NORTH));
		IBlockState stateStairsSouth = getBiomeSpecificBlockState(
				Blocks.STONE_BRICK_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.SOUTH));
		IBlockState stateStairsEast = getBiomeSpecificBlockState(
				Blocks.STONE_BRICK_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.EAST));
		IBlockState stateStairsWest = getBiomeSpecificBlockState(
				Blocks.STONE_BRICK_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.WEST));
		IBlockState statePlanks = getBiomeSpecificBlockState(Blocks.STONEBRICK.getDefaultState());
		IBlockState stateLog = getBiomeSpecificBlockState(Blocks.LOG.getDefaultState());
		fillWithBlocks(parWorld, parStructBB, 1, 1, 1, 7, 4, 4, Blocks.AIR.getDefaultState(),
				Blocks.AIR.getDefaultState(), false);
		fillWithBlocks(parWorld, parStructBB, 2, 1, 6, 8, 4, 10, Blocks.AIR.getDefaultState(),
				Blocks.AIR.getDefaultState(), false);
		...
		fillWithBlocks(parWorld, parStructBB, 1, 0, -1, 3, 2, -1, Blocks.AIR.getDefaultState(),
				Blocks.AIR.getDefaultState(), false);

		if (getBlockStateFromPos(parWorld, 2, 0, -1, parStructBB).getMaterial() == Material.AIR
				&& getBlockStateFromPos(parWorld, 2, -1, -1, parStructBB).getMaterial() != Material.AIR) {
	...
	protected IBlockState getBiomeSpecificBlockState(IBlockState blockstateIn) {
		...
		/*
		 * You can check the biome here using startPiece.biome and modify your structure
		 * accordingly.
		 */
		return blockstateIn;
	}
	 ...
	 * 
	 * @see
	 * net.minecraft.world.gen.structure.StructureVillagePieces.Village#biomeDoor()
	 */
	@Override
