...
public class ContainerRedstoneReceiver extends Container {

	private final TileEntityRedstoneReceiver tileentity;
	private int cookTime, totalCookTime, burnTime, currentBurnTime;
	
	public ContainerRedstoneReceiver(InventoryPlayer player, TileEntityRedstoneReceiver table) {
		this.tileentity = table;
		this.addSlotToContainer(new Slot(tileentity, 0, 61, 35));
		this.addSlotToContainer(new Slot(tileentity, 1, 79, 35));
		this.addSlotToContainer(new Slot(tileentity, 2, 97, 35));
