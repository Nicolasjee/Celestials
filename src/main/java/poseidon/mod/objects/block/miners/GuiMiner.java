...
public class GuiMiner extends GuiContainer {
	...
	private static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MODID + ":textures/gui/minerblock.png");
	private final InventoryPlayer player;
	private final TileEntityMiner table;
	
	public GuiMiner(InventoryPlayer player, TileEntityMiner tile) {
		super(new ContainerMiner(player, tile));
		this.player = player;
		this.table = tile;
	}
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		if(TileEntityMiner.isBurning(table)) {
