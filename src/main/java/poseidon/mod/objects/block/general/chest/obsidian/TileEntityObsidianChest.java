...
public class TileEntityObsidianChest extends TileEntityLockableLoot implements ITickable {
	...
	public String getName() {
		return this.hasCustomName() ? this.customName : "Obsidian Chest";
	}
	...
	@Override
	public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) { return new ContainerObsidianChest(playerInventory, this, playerIn); }
	
	@Override
	public String getGuiID() { return Reference.MODID + ":obsidian_chest"; }
...
//			tick++;
//			if(tick == 20) {
//				Main.proxy.obsidianChest(this.world, this.pos);
//				this.locked = false;
...
//		}
        ...
        if (!this.world.isRemote && this.numPlayersUsing != 0 && (this.ticksSinceSync + pos.getX() + pos.getY() + pos.getZ()) % 200 == 0) {
            ...
            for (EntityPlayer entityplayer : this.world.getEntitiesWithinAABB(EntityPlayer.class, new AxisAlignedBB((double)((float)pos.getX() - 5.0F), (double)((float)pos.getY() - 5.0F), (double)((float)pos.getZ() - 5.0F), (double)((float)(pos.getX() + 1) + 5.0F), (double)((float)(pos.getY() + 1) + 5.0F), (double)((float)(pos.getZ() + 1) + 5.0F)))) {
                if (entityplayer.openContainer instanceof ContainerObsidianChest) {
                    if (((ContainerObsidianChest)entityplayer.openContainer).getChestInventory() == this) {
