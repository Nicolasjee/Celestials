...
public class ContainerSandChest extends Container{

	private final int numRows;
	private final TileEntitySandChest chestIn;
	
	public ContainerSandChest(InventoryPlayer playerInv, TileEntitySandChest chestInv, EntityPlayer player) {
	...
	public TileEntitySandChest getChestInventory() {
		return this.chestIn;
	}
