...
public class BlockLight extends BlockHidden {

	public BlockLight(String name, Material material, float light, float hard, float res, int harvest) {
		super(name, Material.ROCK, light, 0.0F, 0.0F, 0);
	}
	
	@Override
	public TileEntity createTileEntity(World world, IBlockState state) {
		return new TileEntityEnlighten();
	}
