...
public class GuiSummoner extends GuiContainer {
	...
	private static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MODID + ":textures/gui/summoner.png");
	private final InventoryPlayer player;
	private final TileEntitySummoner table;
	
	public GuiSummoner(InventoryPlayer player, TileEntitySummoner tile) {
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		this.fontRenderer.drawString(this.player.getDisplayName().getUnformattedText(), 122, this.ySize - 93 + 2, 4210752);
	}
