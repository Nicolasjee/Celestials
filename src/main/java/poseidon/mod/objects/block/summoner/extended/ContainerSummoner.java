...
public class ContainerSummoner extends Container {
	...
	private final TileEntitySummoner tileentity;
	private int cookTime, totalCookTime, burnTime, currentBurnTime;
	
	public ContainerSummoner(InventoryPlayer player, TileEntitySummoner table) {
		this.tileentity = table;
		this.addSlotToContainer(new Slot(tileentity, 0, 40, 19));
		this.addSlotToContainer(new Slot(tileentity, 1, 80, 15));
		this.addSlotToContainer(new Slot(tileentity, 2, 119, 19));
		this.addSlotToContainer(new Slot(tileentity, 3, 40, 49));
		this.addSlotToContainer(new Slot(tileentity, 4, 80, 54));
		this.addSlotToContainer(new Slot(tileentity, 5, 119, 49));
