...
public class ContainerDrawbridge extends Container {

	private final TileEntityDrawbridge tileentity;
	private int cookTime, totalCookTime, burnTime, currentBurnTime;
	
	public ContainerDrawbridge(InventoryPlayer player, TileEntityDrawbridge table) {
