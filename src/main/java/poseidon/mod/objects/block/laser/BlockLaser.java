...
public class BlockLaser extends BlockBase implements ITileEntityProvider {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if(!worldIn.isRemote && !playerIn.isSneaking()) {
			playerIn.openGui(Main.instance, Reference.GUI_LASER, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
	...
	public static void setState(boolean active, World worldIn, BlockPos pos) {
		...
		if(active) worldIn.setBlockState(pos, BlockInit.LASER.getDefaultState().withProperty(FACING, state.getValue(FACING)));
		else worldIn.setBlockState(pos, BlockInit.LASER.getDefaultState().withProperty(FACING, state.getValue(FACING)));
	...
	*/
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
		TileEntityLaser tile = (TileEntityLaser) worldIn.getTileEntity(pos);
